...
public class TeacherController {
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        TeacherEntity user = TeacherService.selectOne(new EntityWrapper<TeacherEntity>().eq("zhanghao", username));
        if(user==null || !user.getMima().equals(password)) {
            return R.error("账号或密码不正确");
        }
        String token = tokenService.generateToken(user.getId(), username,"Teacher",  "用户" );
    ...
    public R register(@RequestBody TeacherEntity Teacher){
        ...
        TeacherEntity user = TeacherService.selectOne(new EntityWrapper<TeacherEntity>().eq("zhanghao", Teacher.getZhanghao()));
        if(user!=null) {
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        TeacherEntity user = TeacherService.selectById(id);
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,TeacherEntity Teacher, HttpServletRequest request){
        EntityWrapper<TeacherEntity> ew = new EntityWrapper<TeacherEntity>();
        PageUtils page = TeacherService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, Teacher), params), params));
        return R.ok().put("data", page);
    }
    ...
    public R query(TeacherEntity Teacher){
        ...
        return R.ok("查询用户成功").put("data", TeacherView);
    }
    ...
    public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request,
        ...
        Wrapper<TeacherEntity> wrapper = new EntityWrapper<TeacherEntity>();
        if(map.get("remindstart")!=null) {
        ...
        int count = TeacherService.selectCount(wrapper);
