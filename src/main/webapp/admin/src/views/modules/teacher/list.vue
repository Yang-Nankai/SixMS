        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
          ...
          <el-table-column width="300" :align="contents.tableAlign"
            ...
            <template slot-scope="scope">
              ...
              <el-button v-if="isAuth('teacher','查看') && contents.tableBtnIcon == 0" type="success" size="mini"
              ...
              <el-button v-if="isAuth('teacher','修改') && contents.tableBtnIcon == 0" type="primary" size="mini"
              ...
              <el-button v-if="isAuth('teacher','删除') && contents.tableBtnIcon == 0" type="danger" size="mini"
  ...
  data() {
    return {
      ...
      contents: {
        ...
        "inputTitleSize": "14px",
        "btnAdAllBorderColor": "rgba(0, 0, 0, 1)",
        "pageJumper": true,
        ...
        "inputFontColor": "#333",
        "pageEachNum": 10,
        "tableHeaderBgColor": "rgba(0, 0, 0, 1)",
        "inputTitleColor": "#333",
        ...
        "tableBtnBorderColor": "rgba(0, 0, 0, 1)",
        "inputIconPosition": "1",
        "tableBorder": true,
