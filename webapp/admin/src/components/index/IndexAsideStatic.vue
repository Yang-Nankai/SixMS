<template>
  <el-aside class="index-aside" height="100vh" width="250px" >
    ...
    <div class="index-aside-inner menulist" style="height:100%; background-color: #FFFFFF; padding-top: 0;">
...
export default {
  data() {
    return {
      ...
      heads: {"headFontSize":"23px","headBoxShadow":"","headFontColor":"#fff","headTitleImg":false,"headHeight":"80px","headBgColor":"#214B4B","headTitleStyle":"1"},
    }
  },
  mounted() {
