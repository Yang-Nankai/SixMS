  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="科目" prop="kemu">
              <el-input v-model="ruleForm.kemu" 
                placeholder="科目" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="通知" prop="tongzhi">
          <el-select v-model="ruleForm.tongzhi" placeholder="请选择通知">
            <el-option
                v-for="(item,index) in tongzhiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="通知" prop="tongzhi">
	      <el-input v-model="ruleForm.tongzhi"
                placeholder="通知" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kemu = true;
            continue;
	            	            ...
	            	            if(o=='tongzhi'){
            this.ruleForm.tongzhi = obj[o];
	    this.ro.tongzhi = true;
            continue;
          }
	            	            if(o=='riqi'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `kaoshengtongzhi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.kaoshengtongzhiCrossAddOrUpdateFlag = false;
                  this.parent.search();
